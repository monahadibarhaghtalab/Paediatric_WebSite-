...
<!--- instagram --->
            ...
            <div class="row" style="margin-top: 70px; margin-bottom: 70px; max-width: 1000px; margin-left: auto; margin-right: auto;">
               ...
               @foreach ($articles as $article)
                    ...
                    <a href={{'/article/'.$article->article_id}}>{{$article->title}}
                                    ...
                                    <div id="log-in-content">
                                        <div class="row" class="modal-row">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="username" id="username" value="" class="form-control modal-input fa-font-set " placeholder="نام کاربری(انگلیسی)">
                                                </div>
